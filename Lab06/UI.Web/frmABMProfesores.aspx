...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyContentPlaceHolder" runat="server">
    ...
    <form id="form1" runat="server">
            ...
            <div id="buscar">
                <div class="form-inline">
                    <div class="form-group">
                        <asp:Label ID="lblBuscar" runat="server" Text="Buscar por Nombre de Profesor"></asp:Label>
        ...
        <div class="col-5">
            ...
            <div class="d-flex">
                <asp:Button class="ml-auto mr-2 btn btn-default" ID="btnAgregar" runat="server" Text="Agregar"  />
                <asp:Button class="mr-2 btn btn-default" ID="btnGuardar" runat="server" Text="Guardar" />
                <asp:Button class="mr-2 btn btn-default" ID="btnEliminar" runat="server" Text="Eliminar"  />
                <asp:Button class="mr-2 btn btn-default" ID="btnCancelar" runat="server" Text="Cancelar" />
            </div>
        </div>
        <br />
    </form>
